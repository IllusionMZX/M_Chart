#ifndef SPLINECHARTWIDGET_H
#define SPLINECHARTWIDGET_H
...
class SplineChartWidget : public QWidget
{
    Q_OBJECT
public:
    explicit SplineChartWidget(QStandardItemModel  *dataModel,QWidget *parent = nullptr);
