...
LineChartWidget::LineChartWidget(QStandardItemModel  *dataModel,QWidget *parent) : QWidget(parent),dataModel(dataModel),m_slice(0)
{
    this->setMouseTracking(true);
    // create chart
    QChart *chart = new QChart;
    chart->setTitle("Linechart 演示");
    chart->setAnimationOptions(QChart::AllAnimations);
    setPalette(Qt::white);
    setAutoFillBackground(true);
    prepareData();
    connect(m_series,&QLineSeries::clicked, this, &LineChartWidget::do_series_clicked);
    connect(m_series,&QLineSeries::hovered, this, &LineChartWidget::do_series_hovered);
    ...
    chart->setTitle("Simple Linechart 演示");
    ...
    connect(m_themeComboBox, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &LineChartWidget::updateChartSettings);
    connect(m_aaCheckBox, &QCheckBox::toggled, this, &LineChartWidget::updateChartSettings);
    connect(m_animationsCheckBox, &QCheckBox::toggled, this, &LineChartWidget::updateChartSettings);
    connect(m_legendCheckBox, &QCheckBox::toggled, this, &LineChartWidget::updateChartSettings);
    ...
    connect(m_AxissizeFactor, static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &LineChartWidget::updateChartSettings);

    QPushButton *removeline = new QPushButton("删除线条");
    QFormLayout *seriesSettingsLayout = new QFormLayout();
    seriesSettingsLayout->addRow("坐标轴缩放", m_AxissizeFactor);
    ...
    connect(removeline, &QPushButton::clicked, this, &LineChartWidget::remove);
...
void LineChartWidget::prepareData()
{
...
int LineChartWidget::getIndexFromX(QXYSeries *series, qreal xValue, qreal tol)
{
...
void LineChartWidget::updateChartSettings()
{
...
void LineChartWidget::updateSerieSettings()
{

}

void LineChartWidget::updateLineSettings()
{

}

void LineChartWidget::handleSliceClicked()
{

}

void LineChartWidget::showFontDialog()
{
    if (!m_slice)
        return;
...
void LineChartWidget::on_download_clicked()
{
...
void LineChartWidget::remove()
{
    m_lineName->setText("<click a line>");
    m_chartView->chart()->removeSeries(m_series);
}

void LineChartWidget::do_mouseMovePoint(QPoint point)
{
...
void LineChartWidget::do_series_clicked(const QPointF &point)
{
...
void LineChartWidget::do_series_hovered(const QPointF &point, bool state)
{
